...
const ENDPOINTS = [
	...
	{ path: "/vnstat/interfaces",   file: "vnstat.interfaces.uc",   kind: "crud",      domain: "vnstat",   subresource: "interfaces", deprecated: "Removed in v3: this endpoint models `config interface` sections, which vnstat never reads. Use the `interfaces` array on the `vnstat/config` singleton. Note the values differ in kind: this took uci interface names (`lan`), vnstat wants device names (`br-lan`)." },
