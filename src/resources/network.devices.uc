...
return {
	...
	schema_properties: {
		name:    { "x-uapi-read-nullable": true, type: "string",
		...
		vid:     { "x-uapi-read-nullable": true, type: "integer", minimum: 1, maximum: 4094,
		...
		mtu:     { "x-uapi-read-nullable": true, type: "integer", minimum: 0, maximum: 65535 },
