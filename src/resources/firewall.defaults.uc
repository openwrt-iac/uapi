...
return {
	...
	schema_properties: {
		...
		drop_invalid:       { type: "boolean",
		                      description: "Drop packets with invalid conntrack state" },
		synflood_burst:     { type: "integer", minimum: 1, maximum: 1000000 },
		synflood_rate:      { type: "integer", minimum: 1, maximum: 1000000 },
		tcp_syncookies:     { type: "boolean",
		                      description: "Enable kernel TCP SYN cookies" },
		flow_offloading:    { type: "boolean",
		                      description: "Enable software flow offloading" },
		flow_offloading_hw: { type: "boolean",
