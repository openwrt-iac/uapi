...
return {
	...
	schema_properties: {
		...
		noresolv:          { type: "boolean" },
		rebind_protection: { type: "boolean" },
		expandhosts:       { type: "boolean" },
		cachesize:         { type: "integer", minimum: 0, maximum: 1000000 },
		port:              { type: "integer", minimum: 1, maximum: 65535 },
		domainneeded:      { type: "boolean" },
		boguspriv:         { type: "boolean" },
		filterwin2k:       { type: "boolean" },
		authoritative:     { type: "boolean" },
		readethers:        { type: "boolean" },
