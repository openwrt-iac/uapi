...
$SSH 'uci show uhttpd.main.ucode_prefix' | grep -q '/api/v2=/usr/share/uapi/main.uc' \
...
$SSH 'uci show uhttpd.main.ucode_prefix' 2>/dev/null | grep '/api/v2=' && fail "ucode_prefix still wired after removal" || true
echo "  prefix removed"
